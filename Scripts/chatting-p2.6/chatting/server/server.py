...
from chatting.server import udpserver, messagecontroller, messagedatabase
...
def main():
    ...
    msg_handler = messagecontroller.MessageController(event_loop, udp_server, msg_database)
